...
const inputClass = 'h-12 rounded-lg border border-[var(--editable-border)] bg-white px-4 text-base font-bold text-[#102a2f] outline-none transition placeholder:text-[#63777a] focus:border-[#0f4f59] focus:bg-white'
const buttonClass = 'inline-flex h-12 items-center justify-center rounded-lg bg-[#0f4f59] px-6 text-sm font-black uppercase tracking-[0.14em] text-white shadow-sm transition hover:-translate-y-0.5 disabled:opacity-60'
