...
export const editableRootStyle = {
  '--slot4-page-bg': '#f3f8f7',
  '--slot4-page-text': '#102a2f',
  '--slot4-panel-bg': '#ffffff',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#496266',
  '--slot4-soft-muted-text': '#63777a',
  '--slot4-accent': '#0b8587',
  '--slot4-accent-fill': '#0f5a63',
  '--slot4-accent-soft': '#dff0ed',
  '--slot4-dark-bg': '#0f4f59',
  '--slot4-dark-text': '#ffffff',
  '--slot4-media-bg': '#d9e7e5',
  '--slot4-cream': '#ffffff',
  '--slot4-warm': '#f8fbfa',
  '--slot4-lavender': '#e7f2f0',
  '--slot4-gray': '#eef5f4',
  '--slot4-body-gradient': 'linear-gradient(180deg, #eef7f6 0%, #ffffff 42%, #f3f8f7 100%)',
} as CSSProperties
